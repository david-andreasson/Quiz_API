INSERT INTO QUESTIONS (id, question_number, course_name, question_text) VALUES
                                                                            (1, 1, 'OOP Advanced', '1. Vad är huvudsyftet med klasser i objektorienterad programmering?'),
                                                                            ...
                                                                            (60, 60, 'OOP Advanced', '60. Vilken typ av JDBC-URL ska användas för att konfigurera en minnesbaserad H2-databas?'),
                                                                            (61, 61, 'OOP Advanced', '61. Vad är huvudsyftet med att använda Repository-mönstret enligt materialet?'),
                                                                            (62, 62, 'OOP Advanced', '62. Vilken annotation från Lombok genererar automatiskt getters, setters, toString, equals och hashCode metoder?'),
                                                                            (63, 63, 'OOP Advanced', '63. Vilket steg kommer direkt efter att Repository har gjort ett SQL-anrop till databasen enligt flödesdiagrammet?'),
                                                                            (64, 64, 'OOP Advanced', '64. Vad är syftet med @Slf4j annotationen enligt materialet?'),
                                                                            (65, 65, 'OOP Advanced', '65. Hur hanterar Repository-lagret data som kommer från databasen innan det skickas till applikationslagret?'),
                                                                            ...
                                                                            (74, 74, 'OOP Advanced', '74. Vilket snabbkommando används i IntelliJ IDEA (Windows/Linux) för att extrahera en metod?'),
                                                                            (75, 75, 'OOP Advanced', '75. Vilken av följande är INTE en av de listade fördelarna med refactoring enligt materialet?'),
                                                                            (76, 76, 'OOP Advanced', '76. Vad är ett av huvudsyftena med Clean Code enligt materialet?'),
                                                                            (77, 77, 'OOP Advanced', '77. Vilken princip beskrivs som den första nivån av dokumentation och kommunikation i kod?'),
                                                                            ...
                                                                            (92, 92, 'OOP Advanced', '92. Vilket lager i Clean Architecture innehåller företagets grundläggande affärsregler och datastrukturer?'),
                                                                            ...
                                                                            (108, 108, 'OOP Advanced', '108. Vilken metod i Repository-interfacet används för att kontrollera om en entitet existerar utan att hämta data?'),
                                                                            (109, 109, 'OOP Advanced', '109. Vad är syftet med TransactionManager i repository-implementationen?'),
                                                                            (110, 110, 'OOP Advanced', '110. Vilket syfte fyller den abstrakta metoden mapResultSetToEntity i AbstractRepository?'),
                                                                            ...
                                                                            (115, 115, 'OOP Advanced', '115. Vilken typ av index är mest lämplig för queries som söker på flera kolumner samtidigt?'),
                                                                            (116, 116, 'OOP Advanced', '116. Vad är ett huvudsyfte med att använda Joins i relationsdatabaser?'),
                                                                            (117, 117, 'OOP Advanced', '117. Vilken typ av Join behåller alla rader från vänstra tabellen även om det inte finns matchningar i högra tabellen?'),
                                                                            ...
                                                                            (121, 121, 'OOP Advanced', '121. Vilken databas rekommenderas främst för mindre applikationer enligt materialet?'),
                                                                            ...
                                                                            (127, 127, 'OOP Advanced', '127. Vilken av följande är INTE en fördel med Repository Pattern enligt materialet?'),
                                                                            ...
                                                                            (132, 132, 'OOP Advanced', '132. Vilken konfiguration i HikariCP bestämmer det maximala antalet samtidiga databasanslutningar?'),
                                                                            (133, 133, 'OOP Advanced', '133. Vad är huvudsyftet med batch-operationer i databashantering?'),
                                                                            (134, 134, 'OOP Advanced', '134. Vilket är det korrekta SQL-kommandot för att skapa ett index för en e-postkolumn i användartabellen?'),
                                                                            (135, 135, 'OOP Advanced', '135. Vilken typ av mätning är mest lämplig för att övervaka antalet aktiva databasanslutningar enligt materialet?'),
                                                                            ...
                                                                            (142, 142, 'OOP Advanced', '142. Vilket tillstånd befinner sig en JPA-entitet i när den är nyskapad men ännu inte sparad i databasen?'),
                                                                            (143, 143, 'OOP Advanced', '143. Vilken är standardinställningen för laddningsstrategi när det gäller samlingar i JPA?'),
                                                                            (144, 144, 'OOP Advanced', '144. Vilket är det bästa valet mellan JPQL och Criteria API när du behöver bygga dynamiska frågor baserat på användarinput?'),
                                                                            ...
                                                                            (148, 148, 'OOP Advanced', '148. Vilken är den största skillnaden mellan första och andra nivåns cache i Hibernate?'),
                                                                            ...
                                                                            (151, 151, 'OOP Advanced', '151. Vad är en fundamental skillnad mellan SQL och NoSQL databaser när det gäller datastruktur?'),
                                                                            ...
                                                                            (158, 158, 'OOP Advanced', '158. Vilken metod används för att sortera sökresultat i fallande ordning i MongoDB?'),
                                                                            ...
                                                                            (162, 162, 'OOP Advanced', '162. Vilken annotation används för att markera ett fält som dokumentets ID i Morphia?'),
...
(43, 'C', 'Att objekt av en superklass ska kunna ersättas med objekt av dess subklasser utan att påverka programmets korrekthet', TRUE),
...
(59, 'C', 'Genom att starta transaktion, utföra operationer och sedan antingen commit vid lyckat resultat eller rollback vid misslyckande', TRUE),
