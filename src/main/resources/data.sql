...
(1031, 11, 'AI-DATA', '11. Vilken av följande är INTE ett huvudsteg i dataförberedelse för AI?'),
...
(1041, 21, 'AI-DATA', '21. Vad är en av huvudfördelarna med att integrera AI direkt i applikationskod?'),
...
(1051, 31, 'AI-DATA', '31. Vad är Pandas främst användbart för?'),
...
(1061, 41, 'AI-DATA', '41. Vad står CSV för?'),
...
(1071, 51, 'AI-DATA', '51. Vilken av följande är INTE en dimension av datakvalitet enligt föreläsningen?'),
...
(1081, 61, 'AI-DATA', '61. Vad är huvudsyftet med datanormalisering inom maskininlärning?'),
(1082, 62, 'AI-DATA', '62. Vilken formel används för Min-Max normalisering?'),
(1083, 63, 'AI-DATA', '63. Vilket intervall hamnar värdena inom efter Min-Max normalisering?'),
(1084, 64, 'AI-DATA', '64. Vad är kännetecknande för Z-score standardisering?'),
(1085, 65, 'AI-DATA', '65. Efter Z-score standardisering, vad representerar ett värde på +2?'),
(1086, 66, 'AI-DATA', '66. I vilket sammanhang är Min-Max normalisering mest lämplig?'),
(1087, 67, 'AI-DATA', '67. Vilken av följande algoritmer drar särskilt nytta av Z-score standardisering?'),
(1088, 68, 'AI-DATA', '68. Du har en datauppsättning med huspriser (i miljoner kronor): [1.2, 2.5, 3.0, 1.8, 5.5, 2.2, 1.5]. Vad blir det Min-Max normaliserade värdet för 3.0?'),
(1089, 69, 'AI-DATA', '69. Vilket bibliotek används oftast för att utföra datanormalisering i Python?'),
(1090, 70, 'AI-DATA', '70. Vad är ett tecken på att data troligen bör normaliseras innan träning av en AI-modell?'),
(1091, 71, 'AI-DATA', '71. Vilken av följande är den största begränsningen med CSV-formatet?'),
(1092, 72, 'AI-DATA', '72. Vad är huvudsyftet med att konvertera data mellan olika format i ett AI-projekt?'),
(1093, 73, 'AI-DATA', '73. Vilket påstående om JSON är korrekt?'),
(1094, 74, 'AI-DATA', '74. Vilken metod är bäst för att konvertera en kolumn med kommaseparerade värden i en CSV-fil till en array i JSON?'),
(1095, 75, 'AI-DATA', '75. Vilket bibliotek används vanligtvis för datakonvertering mellan format i Python?'),
(1096, 76, 'AI-DATA', '76. Vilken av följande är en fördel med att använda SQLite jämfört med att lagra data i en CSV-fil?'),
(1097, 77, 'AI-DATA', '77. När du konverterar nästlad JSON-data till CSV, vad är bästa praxis för att hantera nästlade objekt?'),
(1098, 78, 'AI-DATA', '78. I vilket scenario är JSON mest lämpligt som dataformat?'),
(1099, 79, 'AI-DATA', '79. Vad är en utmaning när JSON-data som innehåller arrayer konverteras till SQLite?'),
(1100, 80, 'AI-DATA', '80. Vilket av följande påståenden om datakonvertering är sant?'),
(1101, 81, 'AI-DATA', '81. Vad är det huvudsakliga syftet med att konvertera mellan olika dataformat i AI-sammanhang?'),
(1102, 82, 'AI-DATA', '82. Vilken av följande datatyper hanteras annorlunda i JSON jämfört med CSV?'),
(1103, 83, 'AI-DATA', '83. Vad är en mappningsstrategi i datakonverteringssammanhang?'),
(1104, 84, 'AI-DATA', '84. Vilket av följande är ett exempel på "feature engineering" under datakonvertering?'),
(1105, 85, 'AI-DATA', '85. Vilken princip är INTE en del av grundprinciperna för datamappning enligt föreläsningen?'),
(1106, 86, 'AI-DATA', '86. Hur bör man hantera nästlade strukturer i JSON när man konverterar till CSV?'),
(1107, 87, 'AI-DATA', '87. Vilket av följande är INTE en vanlig utmaning vid datakonvertering enligt föreläsningen?'),
(1108, 88, 'AI-DATA', '88. När du väljer vilka fält som ska mappas vid datakonvertering, vilket av följande är viktigast att överväga?'),
(1109, 89, 'AI-DATA', '89. Vilket av följande är bäst lämpat för att representera en produktkatalog med kategorier, underkategorier och produkter?'),
(1110, 90, 'AI-DATA', '90. Vad är det korrekta tillvägagångssättet för att hantera booleska värden (sant/falskt) vid konvertering från JSON till CSV?'),
(1111, 91, 'AI-DATA', '91. Vad är huvudsyftet med att dela upp data i träning, validering och test?'),
(1112, 92, 'AI-DATA', '92. Vilken är den vanligaste fördelningen mellan tränings-, validerings- och testdata?'),
(1113, 93, 'AI-DATA', '93. Vad används valideringsdata till?'),
(1114, 94, 'AI-DATA', '94. Vad är överanpassning (overfitting)?'),
(1115, 95, 'AI-DATA', '95. Vilken uppdelningsmetod bör användas för tidsseriedata?'),
(1116, 96, 'AI-DATA', '96. När är stratifierad uppdelning särskilt viktig?'),
(1117, 97, 'AI-DATA', '97. Vad är korsvalidering (cross-validation)?'),
(1118, 98, 'AI-DATA', '98. Vad är dataläckage i samband med datauppdelning?'),
(1119, 99, 'AI-DATA', '99. Varför ska testdata endast användas en gång?'),
(1120, 100, 'AI-DATA', '100. Vilket av följande är ett vanligt misstag vid datauppdelning?'),
(1121, 101, 'AI-DATA', '101. Vad är det huvudsakliga syftet med att dela upp data i tränings-, validerings- och testdata?'),
(1122, 102, 'AI-DATA', '102. Vilken är den vanligaste fördelningen för tränings-, validerings- och testdata?'),
(1123, 103, 'AI-DATA', '103. När bör man använda stratifierad uppdelning av data?'),
(1124, 104, 'AI-DATA', '104. Vilket av följande format är mest lämpligt för att spara stora dataset med fokus på snabb läsning för analytiska frågor?'),
(1125, 105, 'AI-DATA', '105. Vad är "data leakage" i samband med datauppdelning?'),
(1126, 106, 'AI-DATA', '106. Vilken metod bör användas för att dela upp tidsseriedata?'),
(1127, 107, 'AI-DATA', '107. Vilket Python-bibliotek används vanligtvis för att dela upp data i tränings- och testset?'),
(1128, 108, 'AI-DATA', '108. Vad är korsvalidering och när bör det användas?'),
(1129, 109, 'AI-DATA', '109. Vilket av följande är INTE ett vanligt filformat för att spara maskininlärningsdata?'),
(1130, 110, 'AI-DATA', '110. Vad är temporal leakage i samband med tidsseriedata?'),
(1131, 111, 'AI-DATA', '111. Vad är GDPR?'),
(1132, 112, 'AI-DATA', '112. Vilken av följande är INTE en laglig grund för att samla in personuppgifter enligt GDPR?'),
(1133, 113, 'AI-DATA', '113. Vad är skillnaden mellan anonymisering och pseudonymisering?'),
(1134, 114, 'AI-DATA', '114. Vilken av följande kategorier räknas som känsliga personuppgifter enligt GDPR?'),
(1135, 115, 'AI-DATA', '115. Vad innebär principen om "uppgiftsminimering" enligt GDPR?'),
(1136, 116, 'AI-DATA', '116. För att samtycke ska vara giltigt enligt GDPR måste det vara:'),
...
VALUES
    ...
    (1081, 'A', 'Att göra data lättare att förstå visuellt', false),
    (1081, 'B', 'Att eliminera alla extremvärden från datasetet', false),
    (1081, 'C', 'Att få attribut i olika skalor att bli jämförbara med varandra', true),
    (1081, 'D', 'Att öka hastigheten på databearbetningen', false),

    (1082, 'A', 'X_{norm} = (X - μ) / σ', false),
    (1082, 'B', 'X_{norm} = (X - X_{min}) / (X_{max} - X_{min})', true),
    (1082, 'C', 'X_{norm} = X / X_{max}', false),
    (1082, 'D', 'X_{norm} = X - X_{min}', false),

    (1083, 'A', '-1 till 1', false),
    (1083, 'B', '0 till 1', true),
    (1083, 'C', '-∞ till +∞', false),
    (1083, 'D', 'Intervallet beror på originaldata', false),

    (1084, 'A', 'Värden hamnar alltid mellan 0 och 1', false),
    (1084, 'B', 'Extremvärden (outliers) får mindre påverkan än vid Min-Max normalisering', true),
    (1084, 'C', 'Den används främst för kategoriska variabler', false),
    (1084, 'D', 'Medelvärdet blir 1 och standardavvikelsen blir 0', false),

    (1085, 'A', 'Det ursprungliga värdet är 2 gånger större än medelvärdet', false),
    (1085, 'B', 'Det ursprungliga värdet är dubbelt så stort som det största värdet i datasetet', false),
    (1085, 'C', 'Det ursprungliga värdet ligger 2 standardavvikelser över medelvärdet', true),
    (1085, 'D', 'Det ursprungliga värdet är 2% större än medelvärdet', false),

    (1086, 'A', 'När du arbetar med data som har många extremvärden', false),
    (1086, 'B', 'När du behöver värden som är exakt normalfördelade', false),
    (1086, 'C', 'När du behöver värden strikt mellan 0 och 1 för en algoritm', true),
    (1086, 'D', 'När du utför hypotestest på datan', false),

    (1087, 'A', 'Beslutsträd (Decision Trees)', false),
    (1087, 'B', 'Stödvektormaskiner (SVM)', true),
    (1087, 'C', 'Associationsregler', false),
    (1087, 'D', 'Naiv Bayes-klassificering', false),
    ...
    (1089, 'A', 'NumPy', false),
    (1089, 'B', 'Matplotlib', false),
    (1089, 'C', 'scikit-learn', true),
    (1089, 'D', 'BeautifulSoup', false),

    (1090, 'A', 'Datasetet innehåller främst kategoriska variabler', false),
    (1090, 'B', 'Datasetet har flera attribut med mycket olika skalor', true),
    (1090, 'C', 'Datasetet har för få datapunkter', false),
    (1090, 'D', 'Datasetet innehåller endast heltal', false),
    (1091, 'A', 'Det är svårt att öppna CSV-filer i Excel', false),
    (1091, 'B', 'CSV-filer tar alltid mer lagringsutrymme än JSON', false),
    (1091, 'C', 'CSV kan inte hantera hierarkisk eller nästlad data på ett naturligt sätt', true),
    (1091, 'D', 'CSV stöder inte numeriska datatyper', false),

    (1092, 'A', 'Att minska den totala datamängden som behöver lagras', false),
    (1092, 'B', 'Att öka bearbetningshastigheten för alla algoritmer', false),
    (1092, 'C', 'Att göra data tillgänglig och användbar i olika verktyg och system', true),
    (1092, 'D', 'Att kryptera känslig information i datamängden', false),

    (1093, 'A', 'JSON-format kan bara innehålla strängar, inte numeriska värden', false),
    (1093, 'B', 'JSON stöder hierarkiska strukturer genom nästlade objekt och arrayer', true),
    (1093, 'C', 'JSON kräver mindre lagringsutrymme än CSV för samma datamängd', false),
    (1093, 'D', 'JSON kan bara hantera max 1000 poster i en fil', false),

    (1094, 'A', 'Ignorera kommatecken och behandla hela värdet som en enda sträng', false),
    (1094, 'B', 'Dela upp strängen vid varje kommatecken och skapa en array av resultaten', true),
    (1094, 'C', 'Ersätta kommatecken med semikolon för att undvika konflikter', false),
    (1094, 'D', 'Skapa en separat JSON-fil för varje kommaseparerat värde', false),

    (1095, 'A', 'NumPy', false),
    (1095, 'B', 'Pandas', true),
    (1095, 'C', 'Matplotlib', false),
    (1095, 'D', 'Scikit-learn', false),

    (1096, 'A', 'SQLite-filer kan öppnas direkt i Excel utan konvertering', false),
    (1096, 'B', 'SQLite kräver mindre diskutrymme än CSV för samma data', false),
    (1096, 'C', 'SQLite tillåter komplexa frågor och relationer mellan tabeller', true),
    (1096, 'D', 'SQLite kan bara innehålla textdata, vilket förenklar datahanteringen', false),

    (1097, 'A', 'Ignorera alla nästlade objekt eftersom CSV inte kan representera dem', false),
    (1097, 'B', 'Konvertera objektvärdena till strängar och lagra dem i separata kolumner', false),
    (1097, 'C', 'Använda "plattning" där nästlade nycklar blir separata kolumner med punktnotation', true),
    (1097, 'D', 'Skapa separata CSV-filer för varje nästlad objekt', false),

    (1098, 'A', 'När data ska öppnas och redigeras manuellt i ett kalkylprogram', false),
    (1098, 'B', 'När du behöver minimera filstorleken för stora datamängder', false),
    (1098, 'C', 'När du arbetar med API:er och webbtjänster', true),
    (1098, 'D', 'När du utför komplexa frågor mot data', false),

    (1099, 'A', 'SQLite kan inte lagra arraydata alls', false),
    (1099, 'B', 'Arrayer måste omvandlas till JSON-strängar eller normaliseras till separata tabeller', true),
    (1099, 'C', 'SQLite har en gräns på maximalt 10 element i en array', false),
    (1099, 'D', 'Konvertering från JSON till SQLite kan bara göras manuellt, inte programmatiskt', false),

    (1100, 'A', 'Det är alltid möjligt att konvertera mellan format utan någon informationsförlust', false),
    (1100, 'B', 'Konvertering bör undvikas så mycket som möjligt eftersom det alltid försämrar datakvaliteten', false),
    (1100, 'C', 'Konvertering mellan format kan kräva kompromisser beroende på formatens egenskaper', true),
    (1100, 'D', 'Manuell konvertering ger alltid bättre resultat än automatiserade verktyg', false),
    (1101, 'A', 'Att spara lagringsutrymme genom att komprimera data', false),
    (1101, 'B', 'Att förbättra beräkningshastigheten hos AI-modeller', false),
    (1101, 'C', 'Att göra data från olika källor användbar för AI-modeller', true),
    (1101, 'D', 'Att kryptera känslig information i dataseten', false),

    (1102, 'A', 'Heltal (integers)', false),
    (1102, 'B', 'Nästlade objekt (hierarkisk data)', true),
    (1102, 'C', 'Datumformat', false),
    (1102, 'D', 'Textfält med citattecken', false),

    (1103, 'A', 'Ett verktyg för att automatiskt konvertera mellan dataformat', false),
    (1103, 'B', 'En plan för hur fält från källformatet ska översättas till målformatet', true),
    (1103, 'C', 'En teknik för att komprimera stora datamängder', false),
    (1103, 'D', 'En metod för att indexera databaser för snabbare sökning', false),

    (1104, 'A', 'Att konvertera en CSV-fil till JSON-format', false),
    (1104, 'B', 'Att hantera saknade värden genom att ersätta med standardvärden', false),
    (1104, 'C', 'Att beräkna en persons ålder baserat på födelsedatum', true),
    (1104, 'D', 'Att validera att e-postadresser följer rätt format', false),

    (1105, 'A', 'Bevara semantisk betydelse', false),
    (1105, 'B', 'Hantera datatyper korrekt', false),
    (1105, 'C', 'Maximera datakomprimeringen', true),
    (1105, 'D', 'Skapa meningsfulla namn', false),

    (1106, 'A', 'Ta bort all nästlad data eftersom CSV inte kan hantera den', false),
    (1106, 'B', 'Platta ut nästlade strukturer med en punkt-notation eller genom att skapa nya kolumner', true),
    (1106, 'C', 'Konvertera nästlad data till Base64-kodade strängar', false),
    (1106, 'D', 'Spara nästlad data i separata CSV-filer', false),

    (1107, 'A', 'Nästlade strukturer', false),
    (1107, 'B', 'Tidsstämpelformat', false),
    (1107, 'C', 'Teckenset (encoding)', false),
    (1107, 'D', 'Grafiskt användargränssnitt', true),

    (1108, 'A', 'Att inkludera så många fält som möjligt från källdatan', false),
    (1108, 'B', 'Att minimera storleken på den resulterade datafilen', false),
    (1108, 'C', 'Att välja fält baserat på deras relevans för målsyftet', true),
    (1108, 'D', 'Att prioritera numeriska fält över textfält', false),

    (1109, 'A', 'CSV-format', false),
    (1109, 'B', 'SQL-tabeller', false),
    (1109, 'C', 'JSON-format', true),
    (1109, 'D', 'Platt textfil', false),

    (1110, 'A', 'Konvertera till 1/0 eller "true"/"false" beroende på målsystemets krav', true),
    (1110, 'B', 'Ta bort booleska fält eftersom CSV inte kan hantera dem', false),
    (1110, 'C', 'Konvertera alla booleska värden till strängar för att undvika förvirring', false),
    (1110, 'D', 'Ersätt dem alltid med "Y"/"N" för enhetlighet', false),
    (1111, 'A', 'Att spara lagringsutrymme genom att använda mindre datamängder', false),
    (1111, 'B', 'Att göra träningsprocessen snabbare', false),
    (1111, 'C', 'Att säkerställa att modellen kan generalisera till ny data', true),
    (1111, 'D', 'Att göra det lättare att visualisera data', false),

    (1112, 'A', '33-33-33', false),
    (1112, 'B', '50-25-25', false),
    (1112, 'C', '70-15-15 eller 80-10-10', true),
    (1112, 'D', '90-5-5', false),

    (1113, 'A', 'Att träna modellen på mönster och samband', false),
    (1113, 'B', 'Att finjustera modellens hyperparametrar', true),
    (1113, 'C', 'Att göra den slutliga utvärderingen av modellen', false),
    (1113, 'D', 'Att förbehandla data innan träning', false),

    (1114, 'A', 'När modellen presterar dåligt på både tränings- och testdata', false),
    (1114, 'B', 'När modellen lär sig träningsdatan för bra och inte kan generalisera', true),
    (1114, 'C', 'När modellen tränas för länge och blir för komplex', false),
    (1114, 'D', 'När modellen inte kan hitta mönster i datan', false),

    (1115, 'A', 'Slumpmässig uppdelning', false),
    (1115, 'B', 'Stratifierad uppdelning', false),
    (1115, 'C', 'Tidsseriedelning', true),
    (1115, 'D', 'Korsvalidering', false),

    (1116, 'A', 'När datasetet är mycket stort', false),
    (1116, 'B', 'När datasetet är obalanserat', true),
    (1116, 'C', 'När datasetet innehåller tidsseriedata', false),
    (1116, 'D', 'När datasetet har många features', false),

    (1117, 'A', 'En metod för att träna modellen på all tillgänglig data', false),
    (1117, 'B', 'En metod för att dela upp data i träning, validering och test', false),
    (1117, 'C', 'En metod där man tränar flera modeller på olika delar av datan och tar genomsnittet', true),
    (1117, 'D', 'En metod för att validera modellen mot externa dataset', false),

    (1118, 'A', 'När data från träningsdatan läcker ut på internet', false),
    (1118, 'B', 'När information från test- eller valideringsdata påverkar träningen', true),
    (1118, 'C', 'När modellen läcker minne under träning', false),
    (1118, 'D', 'När data går förlorad under uppdelningsprocessen', false),

    (1119, 'A', 'För att spara beräkningskraft', false),
    (1119, 'B', 'För att undvika att modellen blir för komplex', false),
    (1119, 'C', 'För att få en ärlig bedömning av modellens prestanda', true),
    (1119, 'D', 'För att testdata är mindre viktig än träningsdata', false),

    (1120, 'A', 'Att använda för mycket data för träning', false),
    (1120, 'B', 'Att normalisera data efter uppdelning', false),
    (1120, 'C', 'Att använda slumpmässig uppdelning för tidsseriedata', true),
    (1120, 'D', 'Att använda stratifierad uppdelning för obalanserade dataset', false),
    (1121, 'A', 'För att spara diskutrymme genom att ha mindre dataset', false),
    (1121, 'B', 'För att göra det lättare att visualisera data', false),
    (1121, 'C', 'För att säkerställa att modellen kan generalisera till ny data', true),
    (1121, 'D', 'För att öka beräkningshastigheten vid träning', false),

    (1122, 'A', '33% träning, 33% validering, 33% test', false),
    (1122, 'B', '50% träning, 25% validering, 25% test', false),
    (1122, 'C', '70-80% träning, 10-15% validering, 10-15% test', true),
    (1122, 'D', '90% träning, 5% validering, 5% test', false),

    (1123, 'A', 'När datasetet är mycket stort', false),
    (1123, 'B', 'När man arbetar med tidsseriedata', false),
    (1123, 'C', 'När klasserna i datasetet är obalanserade', true),
    (1123, 'D', 'När man vill spara beräkningstid', false),
    ...
    (1125, 'A', 'När data läcker ut från databasen till obehöriga', false),
    (1125, 'B', 'När information från testdata påverkar träningsprocessen', true),
    (1125, 'C', 'När data går förlorad under uppdelningsprocessen', false),
    (1125, 'D', 'När data dupliceras mellan tränings- och testdata', false),

    (1126, 'A', 'Slumpmässig uppdelning', false),
    (1126, 'B', 'Stratifierad uppdelning', false),
    (1126, 'C', 'Tidsseriedelning (kronologisk uppdelning)', true),
    (1126, 'D', 'K-fold korsvalidering', false),

    (1127, 'A', 'NumPy', false),
    (1127, 'B', 'scikit-learn', true),
    (1127, 'C', 'Pandas', false),
    (1127, 'D', 'TensorFlow', false),

    (1128, 'A', 'En metod för att validera data mot externa källor, används för stora dataset', false),
    (1128, 'B', 'En teknik där data delas upp i flera folds och modellen tränas flera gånger, används för små dataset', true),
    (1128, 'C', 'Ett sätt att kontrollera datakvalitet, används för alla typer av dataset', false),
    (1128, 'D', 'En metod för att jämföra olika modeller, används endast för klassificeringsproblem', false),

    (1129, 'A', 'CSV', false),
    (1129, 'B', 'Parquet', false),
    (1129, 'C', 'HTML', true),
    (1129, 'D', 'SQLite', false),

    (1130, 'A', 'När data från framtiden används för att förutsäga dåtiden', true),
    (1130, 'B', 'När tidsstämplar saknas i datasetet', false),
    (1130, 'C', 'När tidsseriedata lagras i fel format', false),
    (1130, 'D', 'När tidsseriedata innehåller för många nollvärden', false),
    (1131, 'A', 'Ett programmeringsspråk för dataanalys', false),
    (1131, 'B', 'EU:s regelverk för hur personuppgifter får hanteras', true),
    (1131, 'C', 'En typ av AI-modell för datainsamling', false),
    (1131, 'D', 'Ett verktyg för att anonymisera data', false),

    (1132, 'A', 'Samtycke från personen', false),
    (1132, 'B', 'Nödvändigt för att uppfylla ett avtal', false),
    (1132, 'C', 'Företagets önskan att förbättra sin marknadsföring', true),
    (1132, 'D', 'Skydda någons vitala intressen', false),

    (1133, 'A', 'Det finns ingen skillnad, termerna betyder samma sak', false),
    (1133, 'B', 'Anonymiserad data kan inte återidentifieras, pseudonymiserad data kan återidentifieras med en nyckel', true),
    (1133, 'C', 'Anonymiserad data omfattas av GDPR, pseudonymiserad data gör det inte', false),
    (1133, 'D', 'Pseudonymisering är säkrare än anonymisering', false),

    (1134, 'A', 'E-postadress', false),
    (1134, 'B', 'Telefonnummer', false),
    (1134, 'C', 'Religiös övertygelse', true),
    (1134, 'D', 'Postnummer', false),

    (1135, 'A', 'Att man ska samla in så mycket data som möjligt för att få bättre AI-modeller', false),
    (1135, 'B', 'Att man bara ska samla in de personuppgifter som är nödvändiga för det specifika ändamålet', true),
    (1135, 'C', 'Att man ska minimera antalet personer vars data samlas in', false),
    (1135, 'D', 'Att man ska minimera tiden det tar att samla in data', false),

    (1136, 'A', 'Skriftligt och undertecknat', false),
    (1136, 'B', 'Frivilligt, specifikt, informerat och otvetydigt', true),
    (1136, 'C', 'Godkänt av en myndighet', false),
    (1136, 'D', 'Förnyat varje år', false),

    (1137, 'A', 'Böter upp till 20 miljoner euro eller 4% av global omsättning', true),
    (1137, 'B', 'Maximalt 10 000 kronor i böter', false),
    (1137, 'C', 'Endast en varning första gången', false),
    (1137, 'D', 'Automatisk nedstängning av företaget', false),

    (1138, 'A', 'Att samla in all tillgänglig data och sedan filtrera bort det som inte behövs', false),
    (1138, 'B', 'Att bygga in dataskydd från början i utvecklingsprocessen', true),
    (1138, 'C', 'Att ha en sekretesspolicy på företagets webbplats', false),
    (1138, 'D', 'Att använda cookies för att spåra användare', false),

    (1139, 'A', 'Att modellen tränas så snabbt som möjligt', false),
    (1139, 'B', 'Att samla in så mycket data som möjligt utan begränsningar', false),
    (1139, 'C', 'Att säkerställa att träningsdatan är representativ och inte innehåller bias', true),
    (1139, 'D', 'Att modellen alltid ger samma svar oavsett input', false),
